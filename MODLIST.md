...
| [AmbientSounds](https://modrinth.com/mod/ambientsounds) | creativemd | 6.0.1 | #listentonature |
...
| [ClickThrough](https://modrinth.com/mod/clickthrough) | Giselbaer | 1.20 | Click through signs and item frames to chests |
...
| [Cooking for Blockheads](https://modrinth.com/mod/cooking-for-blockheads) | BlayTheNinth | 16.0.4 | Adds a cooking book and multiblock kitchens that only shows recipes you can make with what you currently have in your inventory. |
...
| [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) | RaphiMC | 1.2.15 | Speed up immediate mode rendering in Minecraft |
...
| [JourneyMap](https://modrinth.com/mod/journeymap) | mysticdrew | 5.9.21 | Real-time mapping in game or in a web browser as you explore. |
...
| [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) | FlashyReese | 1.7.2+mc1.20.1-build.101 | Alternative Options Menu for Sodium |
...
| [Sodium](https://modrinth.com/mod/sodium) | jellysquid3 | 0.5.8 | Modern rendering engine and client-side optimization mod for Minecraft |
| [Sound Physics Remastered](https://modrinth.com/mod/sound-physics-remastered) | henkelmax | 1.4.1 | A Minecraft mod that provides realistic sound attenuation, reverberation, and absorption through blocks. |
...
| [WTHIT](https://modrinth.com/mod/wthit) | deirn | 8.10.0 | What the hell is that? |
...
| [Balm](https://modrinth.com/mod/balm) | BlayTheNinth | 7.2.2 | Abstraction Layer (but not really)™ for Blay's multiplatform mods |
| [BCLib](https://modrinth.com/mod/bclib) | quiqueck | 3.0.14 | A Library Mod for the BetterX Team |
| [Bookshelf](https://www.modrinth.com/mod/bookshelf-lib) | Darkhax | 20.1.0 | An open source library for other mods! |
...
| [Collective](https://modrinth.com/mod/collective) | Serilum | 7.60 | 🎓 Collective is a shared library with common code for all of Serilum's mods. |
| [CreativeCore](https://modrinth.com/mod/creativecore) | creativemd | 2.11.28 | A core mod |
...
| [YetAnotherConfigLib](https://modrinth.com/mod/yacl) | isxander | 3.4.2 | A builder-based configuration library for Minecraft. |