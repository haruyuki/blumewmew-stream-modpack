...
| [Cinderscapes](https://modrinth.com/mod/cinderscapes) | Prospector | 4.0.1 | A biome mod expanding the life of The Nether |
...
| [Clumps](https://modrinth.com/mod/clumps) | jaredlll08 | 11.0.0.1 | Clumps XP orbs together to reduce lag |
...
| [e4mc](https://modrinth.com/mod/e4mc) | vgskye | 3.2.0 | Open a LAN server to anyone, anywhere, anytime. |
...
| [Mod Menu](https://modrinth.com/mod/modmenu) | Prospector | 7.0.1 | Adds a mod menu to view the list of mods you have installed. |
...
| [OptiGUI](https://modrinth.com/mod/optigui) | opekope2 | 2.1.1 | Custom inventory GUIs on Fabric&Quilt with OptiFine resource pack support&many more features |
...
| [Sound Physics Remastered](https://modrinth.com/mod/sound-physics-remastered) | henkelmax | 1.20-1.1.1 | A Minecraft mod that provides realistic sound attenuation, reverberation, and absorption through blocks. |
| [Traverse](https://modrinth.com/mod/traverse) | Prospector | 7.0.1 | A biome expansion mod that embraces the simplistic nature of Minecraft biomes |
...
| [Forge Config API Port](https://modrinth.com/mod/forge-config-api-port) | Fuzs | 7.0.0 | Forge's whole config system provided to the Fabric ecosystem. Designed for a multiloader architecture. |
...
| [Puzzles Lib](https://modrinth.com/mod/puzzles-lib) | Fuzs | 7.0.3 | Why's it called Puzzles you ask? That's the puzzle! |
| [Searchables](https://modrinth.com/mod/searchables) | jaredlll08 | 1.0.2 | Searchables is a library mod that adds helper methods that allow for searching and filtering elements based on components, as well as offering built in auto-complete functionality. |
